...
# 讀取環境變數
DISCORD_WEBHOOK_URL_THREAT = os.getenv("DISCORD_WEBHOOK_URL")
MARKDOWN_FILE = "../data/threat_report.md"

def send_discord_message():
    if not DISCORD_WEBHOOK_URL_THREAT:
    ...
    # 發送到 Discord Webhook
    response = requests.post(DISCORD_WEBHOOK_URL_THREAT, json=payload)
