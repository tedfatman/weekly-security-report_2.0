...
# 讀取環境變數
DISCORD_WEBHOOK_URL_FUTURE = os.getenv("DISCORD_WEBHOOK_URL")
MARKDOWN_FILE = "../data/future_report.md"

def send_discord_message():
    if not DISCORD_WEBHOOK_URL_FUTURE:
    ...
    # 發送到 Discord Webhook
    response = requests.post(DISCORD_WEBHOOK_URL_FUTURE, json=payload)
